...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("icecreampack:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("icecreampack:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("icecreampack:pinky", pinkyEventData);
	}
}
